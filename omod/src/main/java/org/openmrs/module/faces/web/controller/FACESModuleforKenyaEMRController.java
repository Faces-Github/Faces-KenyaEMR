 ...
 */
package org.openmrs.module.faces.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.FACESModuleforKenyaEMRController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class FACESModuleforKenyaEMRController {
