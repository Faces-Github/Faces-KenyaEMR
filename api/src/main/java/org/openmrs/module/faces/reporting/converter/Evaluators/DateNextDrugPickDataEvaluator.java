...
@Handler(supports = DateNextDrugPickDataDefinition.class, order = 50)
public class DateNextDrugPickDataEvaluator implements PatientDataEvaluator {
	...
	public EvaluatedPatientData evaluate(PatientDataDefinition definition, EvaluationContext context)
		...
		String qry = "SELECT \n"
		        ...
		        + "if(l_enc3>=l_enc6,Next_TCA_3,Next_TCA) AS Next_DrugPick_Date \n"
